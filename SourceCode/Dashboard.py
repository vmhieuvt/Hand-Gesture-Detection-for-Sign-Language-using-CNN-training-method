...
def predictor():
	...
	if result[0][0] == 1:
		  return 'an' # Originally A
	elif result[0][1] == 1:
		  return 'bacsi' # Originally B
	elif result[0][2] == 1:
		  return 'bai' # Originally C
	elif result[0][3] == 1:
		  return 'ban' # Originally D
	elif result[0][4] == 1:
		  return 'co' # Originally E
	elif result[0][5] == 1:
		  return 'com' # Originally F
	elif result[0][6] == 1:
		  return 'di' # Originally G
	elif result[0][7] == 1:
		  return 'hoc'
	elif result[0][8] == 1:
		  return 'khong'
